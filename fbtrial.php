...
$mytitle = 'Homepage'; //Text to be used by head.php as title
$seodescription = 'Bromley Driving School is the only driving school you will need, their instructors local knowledge gives you the advantage you need when taking your driving test';
$keyewords = '';
require 'head.php';
...
<main id="main">
    ...
    <section id="testimonials" class="testimonials">
      <div class="container">
        ...
        <div class="testimonials-slider swiper text-center" data-aos-delay="100">
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              ...
              <h2 class="display-6">Self confidence boost</h2>
                ...
                <p class="fw-bold">Harold Green</p>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <p class="fw-bold">Kehinde Macauley</p>
              <p class="text-center date">June 18, 2022<br>
              </div>
            </div><!-- End testimonial item -->
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <p class="text-center"><em><?php echo file_get_contents("img/svg/quote.svg"); ?>  passed my driving test in Bromley on Thrusday 15/09/2022. I was really impressed that I got a good Instructor and helped me through my driving test. Thank you.</em></p>
                  <p class="fw-bold">Dao Phatanchee</p>
