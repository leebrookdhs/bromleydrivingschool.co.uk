        ...
        <div class="container py-2">
            <div class="row d-flex justify-content-center">
                <div class="col-12 shadow my-2 col-md-6">
                    <h5 class="d-flex display-6">Driving School for Bromley, Kent &amp; South London</h5>
                </div>
                ...
                <div class="col-lg-3 shadow my-2 col-md-6 col-sm-6">
                    <picture>
                        ...
                        <source type="image/jpg" srcset="img/webp/bromley-_driving_school_lesson_lexus.jpg"><img src="img/webp/bromley-_driving_school_lesson_lexus.jpg" alt="Student and instructor sat in a red car" class="img-fluid" style="width:300px; height:auto; aspect-ratio:1.8462;" loading="lazy">
                    </picture>
                </div>
                <div class="col-lg-3 shadow my-2 col-md-6 col-sm-6">
                    <picture>
                        <source type="image/webp" srcset="img/webp/bsm-Lexus.webp">
                        <source type="image/jpg" srcset="img/webp/bsm-Lexus.jpg"><img src="img/webp/bsm-Lexus.jpg" alt="White Lexus car" class="img-fluid" style="width:300px; height:auto; aspect-ratio:1.8462;" loading="lazy">
                    </picture>
                </div>
                <div class="col-lg-3 shadow my-2 col-md-6 col-sm-6">
                    <picture>
                        <source type="image/webp" srcset="img/webp/bsm-Lexus-dash.webp">
                        <source type="image/jpg" srcset="img/webp/bsm-Lexus-dash.jpg"><img src="img/webp/bsm-Lexus-dash.jpg" alt="Lexus dashboard" class="img-fluid" style="width:300px; height:auto; aspect-ratio:1.8462;" loading="lazy">
                    </picture>
                </div>
                <div class="col-lg-3 shadow my-2 col-md-6 col-sm-6 col-xs-6">
                    <picture>
                        ...
                        <source type="image/jpg" srcset="img/webp/bromley_driving_school_learner_instructor.jpg"><img src="img/webp/bromley_driving_school_learner_instructor.jpg" alt="driver and instructor in a car" style="width:300px; height:auto; aspect-ratio:1.8462;" class="img-fluid" loading="lazy">
                    </picture>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12 col-xl-4 col-lg-4 col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            <h4 class="card-title">Beginner Driving <span class="text-danger fw-bolder mb-0">L</span>essons</h4>
                ...
                <div class="col-12 col-xl-4 col-lg-4 col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            <h4 class="card-title">Intensive Driving Courses</h4>
                ...
                <div class="col-12 col-xl-4 col-lg-4 col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            <h4 class="card-title">Refresher driving courses</h4>
