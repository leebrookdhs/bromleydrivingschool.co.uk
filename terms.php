            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Bromley
                        Driving School if you do not agree to take all of the terms and conditions stated on this page.</p>
                    ...
                    <p>We employ the use of cookies. By accessing Bromley Driving School, you agreed to use cookies in agreement
                        with the Bromley Driving School's <a href="privacy.php">Privacy Policy</a> and <a href="cookie.php">Cookie Policy.</a> </p>
                    ...
                    <p>Unless otherwise stated, Bromley Driving School and/or its licensors own the intellectual property rights
                        for all material on Bromley Driving School. All intellectual property rights are reserved. You may access
                        this from Bromley Driving School for your own personal use subjected to restrictions set in these terms
                        and conditions.</p>
                    <p>You must not:</p>
                    <ul>
                        <li>Republish material from Bromley Driving School</li>
                        <li>Sell, rent or sub-license material from Bromley Driving School</li>
                        <li>Reproduce, duplicate or copy material from Bromley Driving School</li>
                        <li>Redistribute content from Bromley Driving School</li>
                    </ul>
                    <p>This Agreement shall begin on the date hereof. Our Terms and Conditions were created with the help of the <a href="https://www.termsfeed.com/terms-conditions-generator/">TermsFeed Free Terms and Conditions
                            Generator</a>. </p>
                    <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                        certain areas of the website. Bromley Driving School does not filter, edit, publish or review Comments
                        prior to their presence on the website. Comments do not reflect the views and opinions of Bromley Driving
                        School,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their
                    ...
                    <p>You hereby grant Bromley Driving School a non-exclusive license to use, reproduce, edit and authorize
                    ...
                    <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
                        ...
                        absence of Bromley Driving School; and (d) the link is in the context of general resource information.</p>
                    ...
                    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                        website, you must inform us by sending an e-mail to Bromley Driving School. Please include your name, your
                    ...
                    <p>No use of Bromley Driving School's logo or other artwork will be allowed for linking absent a trademark
                        license agreement.</p>
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="my-2"><?php echo file_get_contents("img/svg/pencil-square.svg"); ?> By using our <a href="contact.php">contact
                                form</a> to send us a message about our terms and conditions</li>
                        <li class="my-2"><?php echo file_get_contents("img/svg/telephone.svg"); ?> Phone: <a href="tel:447886366110">07886 366
                                110</a></li>
                    </ul>
                </div>
            </div>
