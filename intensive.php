...
$mytitle = ' Intensive Driving Lessons'; //Text to be used by head.php as title
$seodescription = 'Bromley Driving School offer tailored intensive driving lessons that suit your timescales and learning style';
$keyewords = '';
require 'head.php';
