...
$mytitle = ' Privacy Policy'; //Text to be used by head.php as title
$seodescription = 'We take your privacy seriously at Bromley Driving School, our privacy policy outlines this';
$keyewords = '';
require 'head.php';
...
<section id="breadcrumbs" class="breadcrumbs p-0">
    <div class="container">
        ...
        <h2>Privacy Policy for Bromley Driving School</h2>
    </div>
</section>
<!-- End Breadcrumbs -->
<!-- privacy Section -->
